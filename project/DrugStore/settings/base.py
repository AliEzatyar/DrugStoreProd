...
BASE_DIR = Path(__file__).resolve().parent.parent.parent # creats a dynammic path to use '/'
...
SECRET_KEY = 's=v1m442i!r(^bm=&%-w!i90dsfg908k#$##$HGds#@$#sc7owt7f^@lks+cemipf137cc3&h'
